...
*I've chosen the Auckland Transport Average Daily Traffic dataset. I chose it because I want to understand which roads are busy and which roads are quiet. This is relevant to everyday life. It's useful for exploring data visualisation design.*


- How did AI tools help you understand the data? What did they miss?

*AI helped me understand the dataset. It told me what each column meant and what the values represented. It also pointed out the missing data. What AI couldn't tell me was the reason behind the data. Why is the proportion of cars so high?*


- What design decisions did you make in directing the AI, and what did you learn from this process?

*I told AI to use different colors to classify and display data in graphics. Also ask the AI to place the graphical description in the middle of the chart. At the same time, some unnecessary content explanations generated by AI were manually deleted. AI is not omnipotent. To make good use of AI, on the one hand, we need to give it simple and clear prompts, and on the other hand, we need to be able to read and rewrite the code ourselves.*

- How do the different representations of the same data change what a viewer might understand?

*In colourless graphics, average daily traffic simply indicates which areas have high traffic volume. However, by adding colour and unifying the data, people can visually perceive that even busy areas have roads with spare capacity.*
